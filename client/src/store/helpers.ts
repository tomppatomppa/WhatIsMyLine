...
export const swapScenes = (scene: any[], sceneId: number, destinationId: number): Scene[] => {
    return reorder(scene, sceneId, destinationId)
}

export const swapLines = (scene: Scene, lineId: number, destinationId: number): Scene => {
